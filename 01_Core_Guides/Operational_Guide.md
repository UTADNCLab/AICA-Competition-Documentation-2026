...
- Register for Quanser Portal -- Ask --- and update.
...
2. In QLabs, open Self-Driving Car Studio.
3. Select the Cityscape map.
4. Wait until the Cityscape environment finishes loading completely.
5. After the map is open, continue with `run_all.BAT` or `run_all.m`.
